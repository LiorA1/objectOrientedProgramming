...
namespace Ex05.Logic
{
    public class Board
    {
        ...
        public event InsertionOfChip InsertedChip;

        public event DeletionOfChip DeleteChip;
        ...
        public bool InsertChip(Chip i_Chip, int i_ColumNum, bool i_Update)
        {
            ...
            if (ValidateColumn(i_ColumNum))
            {
                ...
                if(InsertedChip != null && i_Update)
                {
                    // Change The board UI Display.
                    InsertedChip.Invoke(row, i_ColumNum, i_Chip.PlayerNum);
                }
        ...
        public bool RemoveChip(int i_ColumNum, bool i_Update)
        {
            ...
            if (this.IsColNumInRange(i_ColumNum))
            {
                ...
                if (this.IsRowNumInRange(row))
                {
                    ...
                    if(DeleteChip != null && i_Update)
                    {
                        // Change The board UI Display.
                        DeleteChip.Invoke(row, i_ColumNum);
                    }
